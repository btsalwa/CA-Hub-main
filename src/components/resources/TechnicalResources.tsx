...
import { getTechnicalResources, TechnicalResource } from "../../lib/api";
...
const TechnicalResources = () => {
  ...
  const handleDownload = (resource: TechnicalResource) => {
  ...
  const handleViewOnline = (resource: TechnicalResource) => {
